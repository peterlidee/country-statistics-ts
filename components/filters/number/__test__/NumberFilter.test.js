...
describe('components/filters/number/NumberFilter', () => {
  ...
  test('Controls work', async () => {
    ...
    validateNumbersAgainstDefaults.mockImplementation(
      (value1, value2, defaults) => [value1, value2],
    )
    ...
    expect(
      filterRangeCalls[filterRangeCalls.length - 1][0].sliderSelection[0],
    ).toBe(100)
    expect(
      filterRangeCalls[filterRangeCalls.length - 1][0].sliderSelection[1],
    ).toBe(300)
