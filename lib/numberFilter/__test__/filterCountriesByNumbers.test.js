...
const areaSelection = [
  filterDataMock.area.sliderStart,
  filterDataMock.area.sliderEnd,
]
const populationSelection = [
  filterDataMock.population.sliderStart,
  filterDataMock.population.sliderEnd,
]
const densitySelection = [
  filterDataMock.density.sliderStart,
  filterDataMock.density.sliderEnd,
]
...
describe('function filterCountriesByNumbers(countries, activeNumberFilters, selections)', () => {
  test('It returns all countries when no active filters', () => {
    const filteredCountries = filterCountriesByNumbers(extraDataCountries, [], {
      area: areaSelection,
