...
describe('function sortCountries', () => {
  ...
  test('It sorts by the correct key', () => {
    const result1 = sortCountries([...arr], 'keyOne', true)
    const result2 = sortCountries([...arr], 'keyThree', true)
  ...
  test('It correctly sorts text asc and desc', () => {
    const result3 = sortCountries([...arr], 'keyOne', true)
    const result4 = sortCountries([...arr], 'keyOne', false)
  ...
  test('It correctly sorts numbers asc and desc', () => {
    const result5 = sortCountries([...arr], 'keyTwo', true)
    const result6 = sortCountries([...arr], 'keyTwo', false)
